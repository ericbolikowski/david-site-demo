      ...
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-12 lg:px-8">
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold tracking-tight text-white">WeWork Tenerife</span>
          </div>
        </div>
        
        <nav className="columns-2 sm:columns-3 md:flex md:justify-center md:space-x-10" aria-label="Footer">
        ...
        <div className="mt-8 border-t border-blue-700 pt-8">
          <p className="text-center text-xs leading-5 text-gray-300">
            &copy; {new Date().getFullYear()} WeWork Tenerife. All rights reserved.
          </p>
          <p className="text-center text-xs leading-5 text-gray-400 mt-2">
            Avenida Principal 123, Santa Cruz de Tenerife, 38001, Canary Islands, Spain
          </p>
        </div>
      </div>
    </footer>
